...
-- CreateTable
CREATE TABLE "public"."Labeller" (
    "id" SERIAL NOT NULL,
    "address" TEXT NOT NULL,
    "pending_amount" INTEGER NOT NULL,
    "locked_amount" INTEGER NOT NULL,

    CONSTRAINT "Labeller_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Labeller_address_key" ON "public"."Labeller"("address");

-- CreateIndex
CREATE UNIQUE INDEX "Submission_Labeller_id_task_id_key" ON "public"."Submission"("Labeller_id", "task_id");
...
-- AddForeignKey
ALTER TABLE "public"."Submission" ADD CONSTRAINT "Submission_Labeller_id_fkey" FOREIGN KEY ("Labeller_id") REFERENCES "public"."Labeller"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
